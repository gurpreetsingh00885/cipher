...
public class OverlayShowingService extends Service implements OnTouchListener, OnClickListener {
	...
	overlayedButton.setImageResource(R.drawable.overlay);
    ...
    public void onClick(View v) {
		osvc = new Intent(OverlayShowingService.this, MainActivity.class);
		osvc.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		startActivity(osvc);
		stopSelf();
    }
